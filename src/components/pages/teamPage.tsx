  ...
  const teamMembers = [
    {
      ...
      profileImage: "/public/team/fe.svg", // Replace with actual image URL
    },
    {
      gender: "male",
      role: "Backend Developer",
      color: "bg-white", // Custom color
      profileImage: "/public/team/be.svg", // Replace with actual image URL
    },
    {
      gender: "male",
      role: "UI/UX Designer",
      color: "bg-white", // Custom color
      profileImage: "/public/team/uiux.svg", // Replace with actual image URL
    },
    {
      gender: "male",
      role: "DevOps Engineer",
      color: "bg-white", // Custom color
      profileImage: "/public/team/devops.svg", // Replace with actual image URL
    },
    // {
    //   gender: "male",
    ...
    // },
    {
      ...
      color: "bg-white", // Custom color
      profileImage: "/public/team/pm.svg", // Replace with actual image URL
    },
    {
      gender: "male",
      role: "QA Engineer",
      color: "bg-white", // Custom color
      profileImage: "/public/team/qa.svg", // Replace with actual image URL
    },
    // {
    //   gender: "male",
    //   role: "Data Scientist",
    ...
    <div className="h-full">
      ...
      <div className="flex flex-col  xl:flex-row  items-start text-left px-3 xl:px-10 gap-2 h-full xl:h-screen w-full">
        <div className="w-full  h-full p-16  flex justify-center items-center">
          <img src="/public/team.png" className="animate-zoomIn" />
        </div>
