...
const Button3:React.FC<{text:string, classNames?:string; onClick?:() =>void}> = ({text, classNames,onClick}) => {
  ...
  return (
    <div>
      ...
      onClick={onClick}
            type="submit"
            className={` ${classNames}  border border-black flex  justify-center gap-5 text-black  items-center mx-auto shadow-xl text-lg bg-transparent backdrop-blur-md lg:font-semibold isolation-auto  before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-gray-50 hover:text-black before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-12 font-thin py-3 overflow-hidden  rounded-full group `}
          >
